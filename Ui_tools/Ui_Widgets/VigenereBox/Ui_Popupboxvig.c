...
//INCLUDE CRYPTO PART
#include "../../../Crypto_tools/Cipher_Vig/Vigenere.c"
...
void Call_Vig(char font[], char Box[])
{
    sfRenderWindow *pop;
    ...
    pop = sfRenderWindow_create(video_mode, "Cesear parametres",
